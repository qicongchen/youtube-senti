...
mkdir -p temp audio mfcc mfcc_feat asr_feat
...
#python scripts/create_mfcc.py kmeans.${cluster_num}.model $cluster_num list/all.video || exit 1;
...
python scripts/create_asr.py asr/glove.pruned.300d.txt list/all.video || exit 1;
